...
static const _SetMotion_type_support_symbol_names_t _SetMotion_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jetmax_msgs, msg, SetMotion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jetmax_msgs, msg, SetMotion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, jetmax_msgs, msg, SetMotion)() {
  return &::jetmax_msgs::msg::rosidl_typesupport_c::SetMotion_message_type_support_handle;
}
