...
#include "jetmax_msgs/srv/detail/get_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const jetmax_msgs::srv::GetPosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  jetmax_msgs::srv::GetPosition_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const jetmax_msgs::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<jetmax_msgs::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  return &jetmax_msgs::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jetmax_msgs, srv, GetPosition_Request)() {
  return &jetmax_msgs::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_jetmax_msgs
cdr_serialize(
  const jetmax_msgs::srv::GetPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: object_pos
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  jetmax_msgs::srv::GetPosition_Response & ros_message)
{
  // Member: object_pos
...
{
  auto typed_message =
    static_cast<const jetmax_msgs::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<jetmax_msgs::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &jetmax_msgs::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jetmax_msgs, srv, GetPosition_Response)() {
  return &jetmax_msgs::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
{
  return &jetmax_msgs::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jetmax_msgs, srv, GetPosition)() {
  return &jetmax_msgs::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
