...
#include "jetmax_msgs/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const jetmax_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<jetmax_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  return &jetmax_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
