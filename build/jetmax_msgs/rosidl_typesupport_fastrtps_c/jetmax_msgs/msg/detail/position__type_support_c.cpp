...
#include "jetmax_msgs/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
using _Position__ros_msg_type = jetmax_msgs__msg__Position;
...
size_t get_serialized_size_jetmax_msgs__msg__Position(
  const void * untyped_ros_message,
...
static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jetmax_msgs__msg__Position(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_jetmax_msgs
size_t max_serialized_size_jetmax_msgs__msg__Position(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_jetmax_msgs__msg__Position(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jetmax_msgs, msg, Position)() {
