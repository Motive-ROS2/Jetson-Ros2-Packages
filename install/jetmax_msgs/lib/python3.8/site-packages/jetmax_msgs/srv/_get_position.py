...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from jetmax_msgs.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from jetmax_msgs.srv._get_position import GetPosition_Request as Request
    from jetmax_msgs.srv._get_position import GetPosition_Response as Response
